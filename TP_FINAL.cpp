//TP EVALUATIVO AyED I - 1ER CUATRIMESTRE 2021
 //ALUMNA: MARIA FLORENCIA VELLINI.
...
ofstream aux("editinvitados.txt", ios::out);//creo un txt nuevo para ingresar datos temporales y asi guardar los cambios
 ...
 rename("editinvitados.txt","Lista_de_invitados.txt");//renombro el archivo auxiliar con elnombre del original
